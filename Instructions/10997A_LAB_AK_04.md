...
3. Sign in as  **holly@adatumyyxxxx.onmicrosoft.com**, with Holly's password.
...
10. Sign in as  **Ada@Adatumyyxxxx.onmicrosoft.com** by using the password assigned to Ada's account.
...
12. On the  **Auto Account Setup** page, in **Your Name** field, type **Holly**, in the  **Email Address** field, type **holly@ Adatumyyxxxx.onmicrosoft.com**, and in the  **Password** fields, type Holly's password. Click  **Next**.
If prompted, in the  **Windows Security** dialog box, type **Holly@adatumyyxxxx.onmicrosoft.com** and Holly's password. Click  **Finish**. Close the Activation Wizard if it appears. On the  **First things first** page, select **Ask me later**, and then click  **Accept**.
...
19. Open a new InPrivate window, navigate to  **portal.office.com** and sign in as **Abbi@adatumyyxxxx.onmicrosoft.com** with Abbi's password. Click  **Mail**.
...
2. Sign in to Office 365 as  **Ada@Adatumyyxxxx.onmicrosoft.com** with Ada's password.
