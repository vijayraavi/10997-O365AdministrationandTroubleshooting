...
3. Sign in as  **holly@adatumyyxxxx.onmicrosoft.com**, with the password  **Pa55w.rd**.
...
7. Ensure that the  **Subscribe new members** option is selected, and then click **Save**.
...
10. Sign in as  **Ada@Adatumyyxxxx.onmicrosoft.com** by using **Pa55w.rd **as the password.
...
12. In the  **Outlook** window, in the right-upper corner, click **Ada@Adatumyyxxxx.onmicrosoft.com**, and then click  **Open another mailbox**.
...
4. In the  **Enter Credentials** dialog box, in the **User name** box, type **holly@adatumyyxxxx.onmicrosoft.com**.
...
12. On the  **Auto Account Setup** page, in **Your Name** field, type **Holly**, in the  **Email Address** field, type **holly@ Adatumyyxxxx.onmicrosoft.com**, and in the  **Password** fields, type **Pa55w.rd**. Click  **Next**.
If prompted, in the  **Windows Security** dialog box, type **Holly@adatumyyxxxx.onmicrosoft.com** and **Pa55w.rd**. Click  **Finish**. Close the Activation Wizard if it appears. On the  **First things first** page, select **Ask me later**, and then click  **Accept**.

13. Click  **New Email**.

14. In the  **new email** window, in the **To** box, type **Abbi@adatumyyxxxx.onmicrosoft.com**, and then click  **Check Names**.
...
19. Open a new InPrivate window, navigate to  **portal.office.com** and sign in as **Abbi@adatumyyxxxx.onmicrosoft.com** with the password **Pa55w.rd**. Click  **Mail**.
...
4. Type  **.\Mod4_CreateProblem.ps1**, and then press Enter.

5. In the  **Enter Credentials** dialog box, in the **User name** box, type **holly@adatumyyxxxx.onmicrosoft.com**.

6. In the  **Password** box, type **Pa55w.rd**, and then click  **OK**.
...
2. Sign in to Office 365 as  **Ada@Adatumyyxxxx.onmicrosoft.com** with the password **Pa55w.rd**.
...
4. Switch to Microsoft Edge window where you are signed in as holly@adatumyyxxxx.onmicrosoft.com. 
...
12. Switch to the Microsoft Edge window where you are signed in as holly@adatumyyxxxx.onmicrosoft.com.
