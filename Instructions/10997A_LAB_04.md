...
1. On  **LON-CL1**, in Microsoft Edge, navigate to https://portal.office.com/ and sign in as  **holly@adatumyyxxxx.onmicrosoft.com** with Holly's password.
...
5. Sign in as  **Abbi@adatumyyxxxx.onmicrosoft.com** with the password assigned to Abbi.
