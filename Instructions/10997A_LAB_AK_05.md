...
4. In the  **Windows PowerShell credential request** dialog box, enter the user name **Holly@ _Adatumyyxxxx_x.onmicrosoft.com** and Holly's password, and then click  **OK**.
...
9. If needed, sign in as  **Holly@ _Adatumyyxxxx_x.onmicrosoft.com** by using Holly's password.
...
3. Sign in as  **Ada@ _Adatumyyxxxx_x.onmicrosoft.com** by using Ada's password.
...
18. Sign in as  **Ada@ _Adatumyyxxxx_x.onmicrosoft.com** by using Ada's password.
...
3. If needed, sign in as  **Holly@ _Adatumyyxxxx_x.onmicrosoft.com** by using Holly's password.
