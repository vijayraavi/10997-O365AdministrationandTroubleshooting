...
4. In the  **Windows PowerShell credential request** dialog box, enter the user name **Holly@ _Adatumyyxxxx_x.onmicrosoft.com** and the password **Pa55w.rd**, and then click  **OK**.
...
9. If needed, sign in as  **Holly@ _Adatumyyxxxx_x.onmicrosoft.com** by using the password **Pa55w.rd**.
...
5. In the  **Skype for Business** window, in the **Sign-in address** text box, type **Holly@ _Adatumyyxxxx_x.onmicrosoft.com**, and then click  **Sign In**.

6. In the  **password** text box, type **Pa55w.rd**, and then click  **Sign in**. Click  **Yes**.
...
18. Sign in as  **Ada@ _Adatumyyxxxx_x.onmicrosoft.com** by using the password **Pa55w.rd**.
...
3. If needed, sign in as  **Holly@ _Adatumyyxxxx_x.onmicrosoft.com** by using the password **Pa55w.rd**.
...
4. On the  **Skype for Business Autodiscover Web Service** page, in the **Sign-in address** text box, type **Holly@Adatumxxyyyy.onmicrosoft.com**.
...
3. In the  **Sign-in address** text box, type **Holly@Adatumxxyyyy.onmicrosoft.com**, and then click  **Perform Test**.

4. Expand each node in the report. What records were checked? 
SRV records _sip._tls.adatumxxyyyyy.onmicrosoft.com 
_sipfederationtls._tcp.adatumxxyyyyy.onmicrosoft.com 
CNAME records 
sip.adatumxxyyyyy.onmicrosoft.com 
lyncdiscover.adatumxxyyyyy.onmicrosoft.com 
