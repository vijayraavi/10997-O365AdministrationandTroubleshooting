...
6. Sign out, and then sign in as Abbi Skinner by using the username  **Abbi@Adatumyyxxxxx.onmicrosoft.com** and Abbi's password.

7. Access Abbi's Office 365 settings and verify that she does not have the option to install the Office 365 apps.

8. Sign out as Abbi Skinner, and then sign in as  **Beth** by using the username **beth@Adatumyyxxxxx.onmicrosoft.com** and Beth's password.
...
4. When prompted, sign in as  **Holly@adatumyyxxxx.onmicrosoft.com** with Holly's password.
