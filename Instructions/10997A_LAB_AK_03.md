...
4. On the  **Connect to Azure AD** page, type **holly@Adatumyyxxxx.onmicrosoft.com** in **USERNAME** text box, type **Pa55w.rd** in the **PASSWORD** text box, and then click **Next**.
...
9. Open Internet Explorer on  **LON-DS1**, and then navigate to  **https://portal.office.com**. Sign in as  **holly@Adatumyyxxxx.onmicrosoft.com** with the password ** Pa55w.rd**.
...
7. On the  **Connect to Azure AD** page, type **holly@adatumyyxxxx.onmicrosoft.com** in the **USERNAME** field, type **Pa55w.rd** in the **PASSWORD** field, and then click **Next**.
...
3. On the  **Update your password** page, type the temporary password in the **Current password** text box, type **Pa55w.rd** in the **New password** and **Confirm password** text boxes, and then click **Update password and sign in**.
