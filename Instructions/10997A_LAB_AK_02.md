...
11. Verify that  **Adatumyyxxxxx.onmicrosoft.com** is listed in the text box after the at sign (@), where Adatumyyxxxxx is your unique domain name. Expand **Product licenses**, set Office 365 Enterprise E5 to **On**  and then click **Add**.
