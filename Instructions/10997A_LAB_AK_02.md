...
3. Sign in as  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where yyxxxxx is your unique Adatum number, by using the password  **Pa55w.rd**.
...
11. Verify that  **Adatumyyxxxxx.onmicrosoft.com** is listed in the text box after the at sign (@), where Adatumyyxxxxx is your unique domain name, and then click **Add**.
...
4. In the  **Sign in to your account** dialog box, sign in as **Holly@Adatum _yyxxxxx_.onmicrosoft.com**, where  _yyxxxxx_ is your unique Adatum number, by using the password **Pa55w.rd**.

5. At the command prompt, type the following command, and then press Enter;  _Adatumyyxxxxx_ is your unique domain name:

  ```
  New-MsolUser -UserPrincipalName Catherine@Adatumyyxxxxx.onmicrosoft.com -DisplayName "Catherine Richard" -FirstName "Catherine" -LastName "Richard" -Password 'Pa55w.rd' -ForceChangePassword $false -UsageLocation "CH"
  ```

6. At the command prompt, type the following command, and then press Enter;  _Adatumyyxxxxx _is your unique domain name:

  ```
  New-MsolUser -UserPrincipalName tameka@Adatumyyxxxxx.onmicrosoft.com -DisplayName "Tameka Reed" -FirstName "Tameka" -LastName "Reed" -Password 'Pa55w.rd' -ForceChangePassword $false -UsageLocation "CH"
  ```
...
1. At the Windows Azure Active Directory Module for Windows PowerShell prompt on  **LON-CL1**, type the following command, and then press Enter;  _Adatumyyxxxxx_ is your unique domain name:

  ```
  Set-MsolUserPassword -UserPrincipalName "Tameka@Adatumyyxxxxx.onmicrosoft.com" -NewPassword 'Pa55w.rd123'
  ```
...
2. Sign in as  **Holly@Adatumyyxxxxx.onmicrosoft.com**, where  _yyxxxxx_ is your unique Adatum number, by using the password **Pa55w.rd**.
...
2. Sign in as  **Tameka@Adatumyyxxxx.onmicrosoft.com**, where  _Adatumyyxxxx_ is your unique domain name, by using the password **Pa55w.rd123**.
...
6. If prompted, sign in again as  **Tameka@Adatumyyxxxx.onmicrosoft.com** by using the password ** Pa55w.rd**.
...
16. If prompted, sign in again as  **Christie@Adatumyyxxxx.onmicrosoft.com** by using the password ** Pa55w.rd**.
...
4. In the  **New password** and **Confirm password** text boxes, type **Pa55w.rd**, and then click  **Update passwordand sign in**.
...
2. Sign in as  **Sallie@Adatumyyxxxxx.onmicrosoft.com**, where yyxxxxx is your unique Adatum number, by using the password  **Pa55w.rd**.
