...
3. In  **Notepad**, remove all the remaining comment codes in the lines that start with:  "**&lt;!--**" and end with "**--&gt;**" (Note: leave the comment codes on the instructions paragraph at the top of the file) 
so each line of code begins with a "**&lt;**" (less-than symbol).

4. Comment out Microsoft Visio with the  "**&lt;!--**" and "**--&gt;**" codes to make the download quicker,  
...
5. The entire file beginning with "***&lt;Configuration&gt;***"  
