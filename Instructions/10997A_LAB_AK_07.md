...
Click and right-click the  **configuration.xml** file, click **Open with**, and then click  **Notepad**.
...
1. On  **LON-CL1**, switch to Microsoft Edge, browse to  **portal.office.com**, and then sign in as  **holly@Adatumyyxxxxx.onmicrosoft.com** by using Holly's password.
...
16. On the  **Sign in** page, at **https://portal.office.com**, sign in as  **abbi@Adatumyyxxxxx.onmicrosoft.com**, by using Abbi's password.
...
9. In the top-right corner, if no one is signed in click the link  **Sign in to get most out of office.** Sign in as **Beth@adatumYYXXXXX.onmicrosoft.com**, using Beth's password.
...
10. On the  **Activate Office** page, in the **E-mail address** box, type **Beth@AdatumYYXXXXX.onmicrosoft.com**, and then click  **Next**.
