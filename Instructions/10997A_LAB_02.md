...
4. In the  **Enter Credentials** dialog box, sign in as **holly@Adatum _yyxxxxx_.onmicrosoft.com**, where  _yyxxxxx_ is your unique Adatum number, by using the password **Pa55w.rd**.
...
9. Sign in as  **Christie@Adatumyyxxxx.onmicrosoft.com** using the temporary password assigned earlier. Change the password to **Pa55w.rd**.
...
3. When prompted, change Sallie's password to  **Pa55w.rd** and sign in.
...
2. When prompted, sign in as  **Sallie@Adatumyyxxxxx.onmicrosoft.com**, where yyxxxxx is your unique Adatum number, by using the password  **Pa55w.rd**.
