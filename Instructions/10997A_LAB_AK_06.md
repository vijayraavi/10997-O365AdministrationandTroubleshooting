...
3. Sign in as  **holly@Adatum _yyxxxxx_.onmicrosoft.com** (where _yyxxxxx_ is your unique Adatum.com number) with Holly's password.
...
3. Select the  **https://adatum _yyxxxxx_.sharepoint.com/sites/marketing** check box.
...
6. Open an InPrivate window, go to  **https://adatum _yyxxxxx_.sharepoint.com/sites/marketing**, and then sign in as  **Ada@Adatum _yyxxxxx_.onmicrosoft.com** with Ada's password.
...
3. Sign in as  **Beth@Adatum _yyxxxxx_.onmicrosoft.com** with Beth's password.
...
7. If necessary, sign in as  **holly@Adatum _yyxxxxx_.onmicrosoft.com** with Holly's password.
...
18. In Microsoft Edge, open a new InPrivate window, and then connect to  **https://Adatum _yyxxxxx_.sharepoint.com/sites/marketing**.

19. Sign in as  **Beth@Adatum _yyxxxxx_.onmicrosoft.com** with Beth's password.
...
23. Sign in as  **Ella@Adatum _yyxxxxx_.onmicrosoft.com** with Ella's password.
...
9. Sign in as  **holly@Adatum _yyxxxxx_.hostdomain.com** with Holly's password.
...
9. Sign in as  **Beth@adatum _yyxxxxx_.onmicrosoft.com** with Beth's password.
...
17. If prompted to sign in, type  **Beth@adatum _yyxxxxx_.onmicrosoft.com** in the **user name** box, type Beth's password in the **password** box, and then click **Sign In**.
...
7. Sign in as  **Holly@adatum _yyxxxxx_.onmicrosoft.com** with Holly's password.
...
5. When prompted, sign in as  **Holly@adatumyyxxxx.onmicrosoft.com** with Holly's password.
...
7. Sign in as  **abbi@Adatum _yyxxxxx_.onmicrosoft.com** with Abbi's password.
...
19. Sign in with a user name of  **abbi@Adatum _yyxxxxx_.onmicrosoft.com** and Abbi's password.
...
1. On  **LON-CL1**, open Microsoft Edge, and then sign in to  **https://portal.office.com** with the user name **holly@Adatum _yyxxxxx_.onmicrosoft.com**, and Holly's password.
